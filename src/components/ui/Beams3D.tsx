...
const CanvasWrapper: FC<{ children: ReactNode; onError?: () => void }> = ({ children, onError }) => (
    <Canvas
        dpr={[1, 2]}
        frameloop="always"
...
export const Beams3D: FC<BeamsProps> = ({
    beamWidth = 2,
    beamHeight = 15,
    beamNumber = 12,
    lightColor = "#ffffff",
