...
export const Button = ({ variant = "default", size = "sm", className = "", children, href, ...props }: ButtonProps) => {
    const baseClasses =
    ...
    const combinedClasses = `group relative overflow-hidden rounded-full ${baseClasses} ${variants[variant]} ${sizes[size]} ${className}`
