...
export function InteractiveNeuralVortex() {
    ...
    `;
      ...
      void main() {
        ...
        color = vec3(0.1, 0.35, 0.65);
        color = mix(color, vec3(0.02, 0.6, 0.9), 0.32 + 0.16 * sin(2.0 * u_scroll_progress + 1.2));
        color += vec3(0.0, 0.2, 0.5) * sin(2.0 * u_scroll_progress + 1.5);
        color = color * noise;
    ...
    `;
        ...
        const resizeCanvas = () => {
            ...
            canvasEl.width = canvasEl.parentElement.clientWidth * devicePixelRatio;
            canvasEl.height = canvasEl.parentElement.clientHeight * devicePixelRatio;
